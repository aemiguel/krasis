...
def build_long_prompt(model, target_tokens=10000):
    """Build a prompt that's approximately target_tokens long using Gutenberg text."""
    from prompt_utils import build_prompt_tokens
    tokens = build_prompt_tokens(model, target_tokens)
