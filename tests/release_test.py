...
CONFIG_VARIANTS = [
    {"name": "INT4/AWQ/Polar4",   "gpu_bits": 4, "cpu_bits": 4, "attention": "awq"},
    {"name": "INT8/AWQ/Polar4",   "gpu_bits": 8, "cpu_bits": 8, "attention": "awq"},
    {"name": "INT4/BF16/Polar4",  "gpu_bits": 4, "cpu_bits": 4, "attention": "bf16"},
    # Multi-GPU variant — skipped automatically if only 1 GPU available
    {"name": "INT4/AWQ/Polar4 Multi-GPU", "gpu_bits": 4, "cpu_bits": 4, "attention": "awq", "multi_gpu": True},
]
